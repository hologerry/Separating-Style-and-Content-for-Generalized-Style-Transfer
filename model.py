import argparse
import collections
from ops import conv, deconv, batchnorm, relu, lrelu
import os
import numpy as np
import scipy.misc
...
parser.add_argument(
    "--num_parallel_prefetch", type=int, default=30, help="the number of prefetch"
)
parser.add_argument(
...
parser.add_argument(
    "--style_num", type=float, default=50, help="the number of styles in each batch"
)
parser.add_argument(
    "--content_num",
    type=float,
...
parser.add_argument(
    "--target_batch_size", type=int, default=50, help="number of target images in batch"
)
